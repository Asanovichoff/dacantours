 ...
 * Hero.
 *
 * The background is the same Unsplash URL the source project used. It is the
 * one image not in the asset set, so it is not in R2 — see the README's
 * open items.
 */
const HERO_BG =
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          {/* Main Heading */}
          {/* Tailwind v3 emitted the md:/lg: font-size rules after .leading-*, so at those breakpoints the font-size utility's own line-height won and the leading-* class only applied on mobile. v4 orders them the other way, which made this text taller. The explicit md: leading below reproduces v3's rendering exactly at every breakpoint. */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight md:leading-none">
            <span className="block">Adventure Awaits in</span>
            <span className="block text-blue-300">America&apos;s Wild Places</span>
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed md:leading-8">
